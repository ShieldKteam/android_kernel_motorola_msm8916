...
/home/anderson/shield_osprey/tools/dtbToolCM -2 -o /home/anderson/shield_osprey/arch/arm/boot/dt.img -s 2048 -p /home/anderson/shield_osprey/scripts/dtc/ /home/anderson/shield_osprey/arch/arm/boot/dts/
...
rm -f /home/anderson/osprey_shield_kernel_rx.zip
cd flash_zip
zip -r ../arch/arm/boot/shield_kernel.zip ./
mv /home/anderson/shield_osprey/arch/arm/boot/shield_kernel.zip /home/anderson/osprey_shield_kernel_rx.zip
BUILD_END=$(date +"%s")
